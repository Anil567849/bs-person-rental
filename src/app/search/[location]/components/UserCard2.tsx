...
export default function Component({ imageUrl, name, location, age, bio, distance, price}: UserProfileCardProps) {
  ...
  return (
    <Card className="w-full max-w-md mx-auto overflow-hidden bg-gray-200 rounded-xl shadow-lg">
      <div className="relative h-28 bg-[url('https://images.unsplash.com/photo-1636690513351-0af1763f6237?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center">
        ...
        <Button size="icon" variant="ghost" className="absolute top-4 right-4 text-white hover:text-white hover:bg-white/20">
      ...
      <div className="flex border-t border-gray-200">
        <Button variant="ghost" className="flex-1 py-4 text-blue-500 hover:bg-blue-50 rounded-none">
          <MessageCircle className="mr-2 h-5 w-5" />
          Contact
        </Button>
        <Button variant="ghost" className="flex-1 py-4 text-pink-500 hover:bg-pink-50 rounded-none">
